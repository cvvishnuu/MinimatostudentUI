                ...
                <div className = "navigation-container">
                    <Navbar collapseOnSelect expand="sm"  variant="dark">
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav" className = "justify-content-end" >
                            <Nav>
                                <Nav.Item>
                                    <Nav.Link className = "hover-link" onClick = {this.onOpenLoginModal} style = {{padding: "15px", marginRight: "2vw", fontSize: "x-large", color: "white"}} eventKey={3}>
                                        Login
                                    </Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link className = "hover-link" onClick = {this.onOpenSignupModal} style = {{padding: "15px", fontSize: "x-large", color: "white"}} eventKey={2}>
                                        Signup
                                    </Nav.Link>
                                </Nav.Item>
                            </Nav>
